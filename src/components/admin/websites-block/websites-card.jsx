...
function WebsitesCard() {
    ...
    return (
        <>
            ...
            <Table aria-label='websites-table' className='my-2' radius='md'>
                <TableHeader>
                ...
                <TableBody>
                    ...
                    {websites.map((website) => (
                        <TableRow key={website.uuid}>
                            <TableCell>
                                <h1 className='font-bold'>{website.title}</h1>
                            </TableCell>
                            <TableCell>
                                <Image radius='md' width={25} alt={website.title + 'image'} src={website.icon} />
                            </TableCell>
